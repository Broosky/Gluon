...
declare -A repo_urls=(
    ...
    ["Patchworks-Lite"]="https://github.com/Broosky/Patchworks-Lite.git"
    ...
    ["Triggy"]="https://github.com/Broosky/Triggy.git"
